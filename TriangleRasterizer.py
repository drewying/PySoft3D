...
class mainWindow:
    ...
    def __init__(self, width, height):
        self.data = data=numpy.array(numpy.random.random((height,width))*0,dtype=int)
        self.width = width
        self.height = height
        self.root = Tk()
    ...
    def loop(self):
        ...
        self.data = data=numpy.array(numpy.random.random((self.height,self.width))*0,dtype=int)
        self.angle += 0.1
